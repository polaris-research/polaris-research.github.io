...
about:
  template: solana
  image: "https://placehold.co/800x600/171021/e6e7ec?text=Polarization+in+Online Landscapes+and+Radical+Influence+Studies"
  image-shape: rounded
  links:
    - icon: twitter
      text: Twitter
    ...
    - icon: github
      text: GitHub
      href: https://github.com/polaris-research
---
